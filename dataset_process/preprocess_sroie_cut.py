...
def sroie_process(): 
    for test_data  in test_datas:
        ...
        root_test_box_data=os.path.join(root_ocr_test,test_data.replace('.json','.txt'))
        ...
        with open(root_test_box_data,'r',encoding='gbk') as fb:
            ...
            with open(res_gt_result,'w',encoding='utf-8') as fw:
                ...
                for bo in fbs:
                    ...
                    # Adaptive cropping
                    bbox=[int(bbox[0])-minx+10,int(bbox[1])-miny+10,int(bbox[4])-minx+10,int(bbox[5])-miny+10]
